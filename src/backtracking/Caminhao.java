...
public class Caminhao {
    ...
    public void removerRota(Rota rotaSelecionada) {
        rotas.remove(rotaSelecionada);
    }

    public Caminhao clone() throws CloneNotSupportedException {
        Caminhao caminhao = new Caminhao(this.id);
        for (Rota rota : this.rotas) {
            caminhao.adicionarRota(rota);
        }
        return caminhao;
    }
}
